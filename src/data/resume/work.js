...
const work = [
  {
    name: "Heatly - United Infrastructure",
    position: "Senior Software Engineer",
    url: "https://unitedinfrastructure.com/",
    startDate: "2025-04-12",
    summary: `Building scalable RESTful APIs and data processing systems using .NET, C#, and Python, with strong focus on automated deployments, data performance, and production reliability.`,

    highlights: [
      "Designed and developed RESTful APIs using ASP.NET Core Web API with .NET and C# to support frontend applications and enable efficient data exchange between services.",
      "Built scalable backend data import pipelines using Python to process high-volume Heat Pump and EPC datasets, handling gigabyte-scale files with 10,000+ columns while ensuring high performance and data accuracy.",
      "Managed source control, branching strategies, and release workflows using GitHub, implementing CI/CD pipelines with GitHub Actions and infrastructure automation using Terraform.",
      "Led backend and MySQL database releases to production, ensuring smooth, reliable, and automated deployments with minimal downtime.",
      "Developed customized PDF reporting solutions using QuestPDF and C#, generating dynamic reports for both internal business insights and customer-facing documentation.",
    ],
  },
  {
    name: "Wipro",
